"""Handler for the 'workload_nextweek' command."""
...
SUCCESS_TEMPLATE = "Your workload for next week has been updated to {hours} hours.\nThank you!"
FOOTER_TEMPLATE = "#{channel}  •  {time}"

def handle_workload_nextweek(request: dto.CommandRequest) -> dto.CommandResponse:
    """
    Handles the 'workload_nextweek' command by parsing user input,
